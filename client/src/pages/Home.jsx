  ...
  return (
    <div className='w-[100vw] h-[100vh] flex justify-center items-center animate-bgAnimate bg-200% font-poppins' style={{backgroundImage: 'linear-gradient(45deg,#50a3a2,#78cc6d)', backgroundSize: '200%'}} >
      <div className='flex gap-2'>
        <Navbar/>
        <div className='h-[80vh] w-[31vw] rounded-md flex flex-col'>
          ...
          <div className='flex flex-col gap-4  items-center'>
            ...
            <div className='flex gap-4'>
                   ...
                   <a href=""><FaJava className="w-5 h-5"/></a>
                   <a href=""><FaEnvelope className="w-5 h-5"/></a>
                   <a href=""><FaSquareInstagram className="w-5 h-5"/></a>
            </div>
            </div>
